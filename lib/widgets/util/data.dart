...
List notifs = [
  ...
  "${names[random.nextInt(10)]} asked you to join a project️",
...
List projects = List.generate(13, (index)=>{
  "name": "project ${random.nextInt(20)}",
  "dp": "assets/cm${random.nextInt(10)}.jpeg",
  "msg": messages[random.nextInt(10)],
  "counter": random.nextInt(20),
  "time": "${random.nextInt(50)} min ago",
...
List conversation = List.generate(10, (index)=>{
  "username": "project ${random.nextInt(20)}",
  "time": "${random.nextInt(50)} min ago",
